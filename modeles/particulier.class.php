...
class Particulier extends Utilisateur
{
     ...
     * @return array Tableau des annonces publiées.
     */
     ...
     * @param array $listAnnoncePublie Nouvelle liste d'annonces.
     */
    ...
    /**
     * @brief Délit une annonce publiée de ce particulier.
     ...
     * @param Annonce $a L'annonce à ajouter.
     */
     ...
     * @param Annonce $a L'annonce à retirer.
     */
    ...
    /**
     * @brief Vérifie si une annonce existe dans la liste publiée.
     * @param Annonce $a L'annonce à vérifier.
     * @return bool True si présente, sinon False.
     */
